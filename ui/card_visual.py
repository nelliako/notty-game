...
class CardVisual:
    def __init__(self, colour, number, sprite_loader):
        ...
        self.x = 0
        self.base_y = 0
        # Offsets applied when selected
        self.offset_y = -20  # used for horizontal hands (lift upwards)
        self.offset_x = 20   # used for vertical hands (move right)
        # Orientation of parent hand; set by PlayerHand when adding
